...
id: show-hud
title: "Show HUD"
summary: "Render the smallest useful live Hairness HUD for the current context."
...
**ID:** `hairness-routing/show-hud`\
**HACP:** `0.4`\
**Kind:** `presentation`\
**Mode:** `render`\
**Traits:** `read-only`, `presentation`, `hairness-context`\
**Default Binding:** current-home\
**Accepts:** `hacp/content`, `hacp/result`\
**Produces:** `hacp/presentation`\
**Duration:** `once`

**Effect:** Render the smallest useful live Hairness HUD for the current context.
