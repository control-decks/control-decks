---
name: search-session
description: "Orient the current session toward evidence-gathering and return a bounded search brief. Use only when the human explicitly invokes search-session."
---
