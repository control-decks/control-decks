---
name: endroit-context-pick-site
description: "Select one known Endroit Site and load only its current inspectable context. Use only when the human explicitly invokes endroit-context-pick-site."
---
