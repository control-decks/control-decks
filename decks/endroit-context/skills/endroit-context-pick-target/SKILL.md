---
name: endroit-context-pick-target
description: "Select one known Endroit Target and load only its current inspectable context. Use only when the human explicitly invokes endroit-context-pick-target."
---
