---
name: hairness-context-any-target
description: "Enumerate known Hairness Targets and select the unique semantic match for the current subject. Use only when the human explicitly invokes hairness-context-any-target."
---
