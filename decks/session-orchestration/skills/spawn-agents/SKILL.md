---
name: spawn-agents
description: "Spawn the requested count of agents on independent bounded slices of the current work. Use only when the human explicitly invokes spawn-agents."
---
